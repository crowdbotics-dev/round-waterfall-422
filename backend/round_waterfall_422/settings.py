"""
Django settings for round_waterfall_422 project.
...
ROOT_URLCONF = 'round_waterfall_422.urls'
...
WSGI_APPLICATION = 'round_waterfall_422.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "round_waterfall_422 API",
    "DESCRIPTION": "API documentation for round_waterfall_422 App",
    "VERSION": "v1",
}
